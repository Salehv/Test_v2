...
namespace Assets.SimpleAndroidNotifications
{
    public static class NotificationManager
    {
        ...
        public static int Send(TimeSpan delay, string title, string message, Color smallIconColor,
        ...
        public static int SendCustom(NotificationParams notificationParams)
        {
            ...
            Debug.LogWarning(
                "Simple Android Notifications are not supported for current platform. Build and play this scene on android device!");
